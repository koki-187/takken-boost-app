...
// .wrangler/tmp/bundle-g1bjzv/checked-fetch.js
...
// .wrangler/tmp/pages-v1NkUS/bundledWorker-0.02200338899706966.mjs
...
var St = /* @__PURE__ */ __name2((e, t, s) => t in e ? Rt(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s, "St");
var p = /* @__PURE__ */ __name2((e, t, s) => St(e, typeof t != "symbol" ? t + "" : t, s), "p");
var ke = /* @__PURE__ */ __name2((e, t, s) => t.has(e) || Ue("Cannot " + s), "ke");
var c = /* @__PURE__ */ __name2((e, t, s) => (ke(e, t, "read from private field"), s ? s.call(e) : t.get(e)), "c");
var g = /* @__PURE__ */ __name2((e, t, s) => t.has(e) ? Ue("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), "g");
var f = /* @__PURE__ */ __name2((e, t, s, r) => (ke(e, t, "write to private field"), r ? r.call(e, s) : t.set(e, s), s), "f");
var x = /* @__PURE__ */ __name2((e, t, s) => (ke(e, t, "access private method"), s), "x");
var We = /* @__PURE__ */ __name2((e, t, s, r) => ({ set _(n) {
  f(e, t, n, s);
}, get _() {
  return c(e, t, r);
} }), "We");
var $e = /* @__PURE__ */ __name2((e, t, s) => (r, n) => {
  let i = -1;
  return o(0);
  async function o(l) {
...
var Mt = /* @__PURE__ */ __name2((e) => He(e, decodeURI), "Mt");
var nt = /* @__PURE__ */ __name2((e) => {
...
var re = /* @__PURE__ */ __name2((e, t, ...s) => (s.length && (t = re(t, ...s)), `${(e == null ? void 0 : e[0]) === "/" ? "" : "/"}${e}${t === "/" ? "" : `${(e == null ? void 0 : e.at(-1)) === "/" ? "" : "/"}${(t == null ? void 0 : t[0]) === "/" ? t.slice(1) : t}`}`), "re");
var it = /* @__PURE__ */ __name2((e) => {
...
var De = /* @__PURE__ */ __name2((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? He(e, ot) : e) : e, "De");
var at = /* @__PURE__ */ __name2((e, t, s) => {
  let r;
  if (!s && t && !/[%+]/.test(t)) {
    let o = e.indexOf(`?${t}`, 8);
...
var Lt = at;
var Ht = /* @__PURE__ */ __name2((e, t) => at(e, t, true), "Ht");
var ot = decodeURIComponent;
var Be = /* @__PURE__ */ __name2((e) => He(e, ot), "Be");
var ae;
var j;
var L;
var lt;
...
var ct = (Je = class {
...
}, ae = /* @__PURE__ */ new WeakMap(), j = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakSet(), lt = /* @__PURE__ */ __name2(function(e) {
  const t = c(this, j)[0][this.routeIndex][1][e], s = x(this, L, Pe).call(this, t);
  return s && /\%/.test(s) ? Be(s) : s;
}, "lt"), dt = /* @__PURE__ */ __name2(function() {
  ...
  return e;
}, "dt"), Pe = /* @__PURE__ */ __name2(function(e) {
  return c(this, j)[1] ? c(this, j)[1][e] : e;
}, "Pe"), U = /* @__PURE__ */ new WeakMap(), Je);
var Ft = { Stringify: 1 };
var ut = /* @__PURE__ */ __name2(async (e, t, s, r, n) => {
...
var Wt = (Ye = class {
  ...
  constructor(e, t) {
    ...
    p(this, "html", (e2, t2, s) => {
      const r = /* @__PURE__ */ __name2((n) => x(this, W, ne).call(this, n, t2, Me("text/html; charset=UTF-8", s)), "r");
...
var Vt = /* @__PURE__ */ __name2((e) => e.text("404 Not Found", 404), "Vt");
...
var pt = (Ke = class {
  ...
  route(t, s) {
    ...
    return s.routes.map((n) => {
      var o;
      let i;
      s.errorHandler === ze ? i = n.handler : (i = /* @__PURE__ */ __name2(async (l, a) => (await $e([], s.errorHandler)(l, () => n.handler(l, a))).res, "i"), i[zt] = n.handler), x(o = r, y, G).call(o, n.method, n.path, i);
    }), this;
  }
  basePath(t) {
  ...
  mount(t, s, r) {
    let n, i;
    r && (typeof r == "function" ? i = r : (i = r.optionHandler, r.replaceRequest === false ? n = /* @__PURE__ */ __name2((a) => a, "n") : n = r.replaceRequest));
    const o = i ? (a) => {
      const d = i(a);
    ...
    const l = /* @__PURE__ */ __name2(async (a, d) => {
...
}, A = /* @__PURE__ */ new WeakMap(), y = /* @__PURE__ */ new WeakSet(), mt = /* @__PURE__ */ __name2(function() {
...
}, "mt"), C = /* @__PURE__ */ new WeakMap(), G = /* @__PURE__ */ __name2(function(t, s, r) {
...
}, "G"), Re = /* @__PURE__ */ __name2(function(t, s) {
  if (t instanceof Error) return this.errorHandler(t, s);
  throw t;
}, "Re"), Se = /* @__PURE__ */ __name2(function(t, s, r, n) {
...
}, $ = /* @__PURE__ */ new WeakMap(), B = /* @__PURE__ */ new WeakMap(), ue = /* @__PURE__ */ new WeakSet(), wt = /* @__PURE__ */ __name2(function() {
...
}, "wt"), vt = /* @__PURE__ */ __name2(function(e) {
  const t = [];
  let s = e === E;
...
}, V = /* @__PURE__ */ new WeakMap(), R = /* @__PURE__ */ new WeakMap(), X = /* @__PURE__ */ new WeakMap(), de = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakSet(), J = /* @__PURE__ */ __name2(function(e, t, s, r) {
  const n = [];
...
var Ve = /* @__PURE__ */ __name2((e, t = is) => {
...
var ds = /* @__PURE__ */ __name2(async (e, t) => {
  let s;
...
var us = /* @__PURE__ */ __name2((e) => async function(s, r) {
  return ls({ ...e, getContent: /* @__PURE__ */ __name2(async (i) => ds(i, { manifest: e.manifest, namespace: e.namespace ? e.namespace : s.env ? s.env.__STATIC_CONTENT : void 0 }), "getContent") })(s, r);
}, "us");
var Ce = /* @__PURE__ */ __name2((e) => us(e), "Ce");
var ee = new Ae();
...
// .wrangler/tmp/pages-v1NkUS/4gwkfz3enla.js
...
// .wrangler/tmp/bundle-g1bjzv/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-g1bjzv/middleware-loader.entry.ts
...
//# sourceMappingURL=4gwkfz3enla.js.map
